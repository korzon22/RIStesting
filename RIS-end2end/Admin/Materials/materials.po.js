...
var AngularHCUnits = function() {
  this.pagesSelector = element(by.css("div[class='main-footer clearfix ng-scope']"))
    .element(by.css('.select2-choice'));
  this.pages5 = element.all(by.css("li[class='select2-results-dept-0 select2-result select2-result-selectable']"))
    .get(0);
  ...
  this.materialName = element(by.model('formData.name'));
  this.materialTypeDropdown = element.all(by.css("div[class='select2-container form-control ng-scope " +
    "ng-isolate-scope ng-pristine ng-valid ng-valid-required']")).get(0);

  this.materialUnitDropdown = element(by.css("div[class='select2-container form-control ng-scope " +
